...
export const ALBUMS: Album[] = [
  ...
  new Album("Alive", "Daft Punk", "Live album from electronic duo.", 7),
  new Album("Ash & Ice", "The Kills", "Finally got their shit together and released a near perfect album", 8),
];
